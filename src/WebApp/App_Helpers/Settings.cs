...
namespace WebApp
{
  ...
  public static class Settings
  {
    ...
    public static readonly string GpsAccount = GetValue<string>("gpsaccount");
    public static readonly string GpsPassword = GetValue<string>("gpspassword");
    public static readonly string GpsApiURL = GetValue<string>("gpsapi");
    public static readonly string MapKey = GetValue<string>("mapkey");
    public static readonly string GpsAppKey = GetValue<string>("gpsappkey");
    /// <summary>
